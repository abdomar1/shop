...
function afficher(event) {
    ...
    src1=URL.createObjectURL(files[0]);
    document.getElementById('profil').src=src1;
}
function checher(event){
    inpt=document.getElementById('chercher');
    if(event.key==='Enter'){
        window.location.href="http://localhost/click_shop/admin/index.php?search="+inpt.value
    }
}
(function($) {
    "use strict";
